...
- [ ] **P1 · Surface loopback capture availability.** Recording startup can continue after meeting-audio capture fails or times out, but the UI does not explain that only the microphone is being transcribed.
