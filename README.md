...
- Complete x64 and ARM64 portable archives are generated with the installers.
  Authenticode/SignPath trust and signed in-app update acceptance remain manual
...
GitHub Actions first requires the physical x64 and ARM64 hardware gate, then
